...
# map = dl_read_gcp('gs://my-bucket/pass1b-06/transcript-rna-seq/mapping/pass1b-06_transcript-rna-seq_feature-mapping_20210721.txt', sep='\t')
...
#   dmaqc_metadata = 'gs://my-bucket/pass1b-06/v1.0/results/phenotype/pass1b_6m_viallabel_data.txt'
#   dmaqc_dict = 'gs://my-bucket/pass1b-06/v1.0/results/phenotype/merged_dictionary.txt'
#   
...
preprocess_pass1b_rnaseq_gcp = function(TISSUE_CODE, SEX, gsutil_path='~/google-cloud-sdk/bin/gsutil', scratch='/oak/stanford/groups/smontgom/nicolerg/tmp', outliers=NULL, parallel=F){
  ...
  # load counts 
  counts = dl_read_gcp(sprintf('gs://my-bucket/pass1b-06/v1.0/results/transcriptomics/%s/transcript-rna-seq/motrpac_pass1b-06_%s_transcript-rna-seq_rsem-genes-count.txt', TISSUE_CODE, TISSUE_CODE), 
                       tmpdir = scratch, 
  ...
  tmm = dl_read_gcp(sprintf('gs://my-bucket/pass1b-06/v1.0/analysis/transcriptomics/transcript-rna-seq/normalized-data/motrpac_pass1b-06_%s_transcript-rna-seq_normalized-log-cpm.txt', TISSUE_CODE), 
                    tmpdir = scratch, 
                    GSUTIL_PATH = gsutil_path,
                    check_first = parallel)
  ...
  # RNA-seq metadata 
  qa_qc = dl_read_gcp('gs://my-bucket/pass1b-06/v1.0/results/transcriptomics/qa-qc/motrpac_pass1b-06_transcript-rna-seq_qa-qc-metrics.csv', 
                      sep=',', 
                      tmpdir = scratch, 
                      GSUTIL_PATH = gsutil_path,
                      check_first = parallel)
...
preprocess_pass1b_atacseq_gcp = function(TISSUE_CODE, # or dataset, if it starts with tissue_code
  ...
  # ATAC-seq meta 
  wet = dl_read_gcp('gs://my-bucket/pass1b-06/v1.0/results/epigenomics/qa-qc/motrpac_pass1b-06_epigen-atac-seq_qa-qc-metrics.csv', sep=',', check_first = T)
  # DMAQC metadata 
  ...
  # load raw counts 
  counts = dl_read_gcp(sprintf("gs://my-bucket/pass1b-06/v1.0/results/epigenomics/%s/epigen-atac-seq/motrpac_pass1b-06_%s_epigen-atac-seq_counts.txt.gz",TISSUE_CODE,TISSUE_CODE), check_first = T)
...
transcript_prep_data = function(tissue_code, 
  ...
  # load outliers
  if(is.null(outliers)){
    rna_outliers = dl_read_gcp('gs://my-bucket/pass1b-06/transcript-rna-seq/dea/pass1b-06_transcript-rna-seq_removed-outliers_20201028.txt', sep='\t', check_first=parallel)
